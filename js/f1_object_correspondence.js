        ...
        CrossPlatformDragManager: {
            ...
            init(difficulty, config) {
                ...
                if (typeof Sortable === 'undefined') {
                    Game.Debug.logError('SortableJS 未載入', 'CrossPlatformDragManager.init');
                    return;
                }
            ...
            setupSortableInstances(difficulty, config) {
                ...
                if (sourceContainer) {
                    const sourceInstance = new Sortable(sourceContainer, {
                        ...
                        animation: 150,
                        forceFallback: true, // 確保在所有設備上使用自定義拖曳
                        ...
                        onStart: (evt) => {
                            ...
                            Game.handleDragStart(mockEvent);
                        },
                ...
                // 為放置區域設置拖曳
                const placementZones = document.querySelectorAll('.placement-zone');
                placementZones.forEach((zone, index) => {
                        ...
                        onAdd: (evt) => {
                            ...
                            const mockDropEvent = {
                                ...
                                dataTransfer: {
                                    getData: (type) => {
                                        if (type === 'text/plain') {
                                            return evt.item.dataset.id || evt.item.dataset.index || '';
                                        }
                                        if (type === 'icon') {
                                            return evt.item.dataset.icon || '';
                                        }
                                        return '';
                                    }
                                },
                ...
                Game.Debug.logUI('✅ 所有放置區域 Sortable 實例已創建', { count: placementZones.length });
            },
